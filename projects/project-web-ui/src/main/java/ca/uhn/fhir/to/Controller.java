...
import ca.uhn.fhir.to.model.ShahimRequest;
...
public class Controller extends BaseController {
	...
	@ModelAttribute
	ShahimRequest getShahimRequest(ShahimRequest shahimRequest, final ModelMap theModel, HttpServletRequest theServletRequest){
		System.out.println(shahimRequest);
		return new ShahimRequest();
	}

	@RequestMapping(value = { "/", "/home" })
	public String actionHome(HttpServletRequest theServletRequest, final HomeRequest theRequest, final HomeRequest theRequest2, final ShahimRequest shahimRequest, final BindingResult theBindingResult, final ModelMap theModel) {
		addCommonParams(theServletRequest, theRequest, theModel);
